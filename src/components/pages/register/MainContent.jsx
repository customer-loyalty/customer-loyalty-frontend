...
function MainContent() {
  ...
  return (
    <div className="max-w-[1920px] mx-auto pl-[200px] flex justify-between">
      <div className="mt-[54px] max-w-[692px]">
        <h1 className="text-4xl font-bold text-[#F6F7F8] mb-10">
          Попробовать 30-дневный пробный период
        </h1>
        <form
        ...
        >
          ...
          <div className="flex gap-4 items-center mt-[124px] mb-5">
            <input
              className="bg-[#1e1c1c] w-6 h-6"
              id="acceptCheck"
              required
              type="checkbox"
              onChange={onAcceptChange}
            />
            <p className="text-[#F6F7F8] text-[12px] font-normal">
              нажимая «Зарегистрироваться» вы соглашаетесь с договором оферты и
      ...
      <img src={mock} alt="пример личного кабинета" className="" />
    </div>
  );
}
